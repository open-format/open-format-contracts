...
contract PaymentSplitter is Context {
    ...
    // Revshare amount
    uint256 internal _totalDepositedAmount;
    uint256 internal _totalDepositedReleased;
    ...
    /**
     * @dev Getter for the amount of Ether deposited via the deposit() function.
     */
    ...
    /**
     * @dev Getter for the amount of Ether already release via the withdraw() function.
     */

    function totalDepositedReleased() public view returns (uint256) {
        return _totalDepositedReleased;
    }
